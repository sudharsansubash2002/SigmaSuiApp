            ...
            <Row className="gx-3 mb-lg-4 mb-2">
                ...
                <Col xs={12} lg={4} className="mb-3">
                    <div className="info-card info-card-7 d-flex flex-column justify-content-between">
                        ...
                        <h3 className="mb-0">Sui Testnet</h3>
                    </div>
                </Col>
            </Row>
                        ...
                        <Table hover responsive>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><Badge pill bg="secondary" className="text-truncate"><img src={Wallet} alt="Wallet" /> Default | {"0x604f7248a1454c44a2e95e363c714d715eada5b5ae41e75fa1ce343e7aee2c25"}</Badge></td>
                                    <td>
                                        <Button variant="reset" onClick={() => {navigator.clipboard.writeText("0x604f7248a1454c44a2e95e363c714d715eada5b5ae41e75fa1ce343e7aee2c25"); toggleShowA();}}>
                                            <img src={CopyIcon} alt="CopyIcon" />
                                        </Button>
                                    </td>
                                </tr>
                        ...
                        <ListGroup variant="flush">
                            <ListGroup.Item className="d-flex py-3 align-items-center">
                                ...
                                <div className="list-content pe-2 flex-grow-1">
                                    ...
                                    <p className="text-break">{"https://fullnode.testnet.sui.io:443"}</p>
                                </div>
                                <div className="list-copy">
                                    <Button variant="reset" onClick={() => {navigator.clipboard.writeText( convertToConnectUrl("https://fullnode.testnet.sui.io:443")); toggleShowA();}}>
                                        <img src={CopyIcon} alt="CopyIcon" />
                                    </Button>
                                </div>
                            </ListGroup.Item>
                            <ListGroup.Item className="d-flex py-3 align-items-center">
                                ...
                                <div className="list-content pe-2 flex-grow-1">
                                    ...
                                    <p className="text-break">{"wss://fullnode.testnet.sui.io"}</p>
                                </div>
                                <div className="list-copy">
                                    <Button variant="reset" onClick={() => {navigator.clipboard.writeText(convertToWebSocketUrl("wss://fullnode.testnet.sui.io")); toggleShowA();}}>
                                        <img src={CopyIcon} alt="CopyIcon" />
                                    </Button>
                                </div>
                            </ListGroup.Item>
